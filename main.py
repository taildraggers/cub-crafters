"""Scrape CubCrafters listings from Barnstormers.com and render them
...
PAGE_TITLE = "Other CubCrafters Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    ("Trade-A-Plane", "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=cubcrafters&s-original-search=cubcrafters"),
    ("Controller", "https://www.controller.com/listings?keywords=cubcrafters"),
    ("ASO", "https://aso.com/search?q=CubCrafters"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More CubCrafters Listings</h2>
    <p>View additional CubCrafters Aircraft listings at these fine sites:</p>
